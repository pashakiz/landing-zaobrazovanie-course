...
function epixx_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary Menu', 'epixx' ),
	) );
...
function epixx_scripts() {
	...
	wp_enqueue_script( 'epixx-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'epixx-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
